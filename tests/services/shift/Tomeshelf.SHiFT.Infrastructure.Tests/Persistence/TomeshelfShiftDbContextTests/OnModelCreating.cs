...
public class OnModelCreating
{
    ...
    public void SettingsEntity_IsConfiguredWithExpectedMetadata()
    {
        ...
        var options = new DbContextOptionsBuilder<TomeshelfShiftDbContext>()
                      .UseInMemoryDatabase($"ShiftSettingsTest-{Guid.NewGuid():N}")
                      .Options;
