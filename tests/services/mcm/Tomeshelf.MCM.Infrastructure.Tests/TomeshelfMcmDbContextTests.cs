...
public class TomeshelfMcmDbContextTests
{
    ...
    public void Entities_AreConfiguredWithExpectedMetadata()
    {
        ...
        updatedAtProperty.Should()
                         .NotBeNull();
        updatedAtProperty!.IsNullable
                          .Should()
                          .BeFalse();
        ...
        addedAtProperty.Should()
                       .NotBeNull();
        addedAtProperty!.IsNullable
                        .Should()
                        .BeFalse();
        addedAtProperty.GetDefaultValueSql()
                       .Should()
                       .Be("SYSDATETIMEOFFSET()");
