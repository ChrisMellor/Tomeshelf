...
public class DeleteAsync
{
    ...
    public async Task DeletesEventWithoutGuests_WhenFound()
    {
        ...
        var eventEntity = new EventEntity { Id = eventId, Name = "Event 1" };
    ...
    public async Task DeletesEventWithGuests_WhenFound()
    {
        ...
        var guest = new GuestEntity { Id = guestId, GuestInfoId = guestInfoId };
        var guestInfo = new GuestInfoEntity { Id = guestInfoId, FirstName = "John", LastName = "Doe", GuestId = guestId };
        var eventEntity = new EventEntity { Id = eventId, Name = "Event 1", Guests = new List<GuestEntity> { guest } };
