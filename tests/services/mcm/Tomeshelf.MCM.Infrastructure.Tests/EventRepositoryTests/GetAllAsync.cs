...
public class GetAllAsync
{
    ...
    public async Task ReturnsEventsOrderedByName()
    {
        ...
        var event1 = new EventEntity { Id = "id-2", Name = "Event B" };
        var event2 = new EventEntity { Id = "id-1", Name = "Event A" };
        ...
        result.First().Name.ShouldBe("Event A");
        result.Last().Name.ShouldBe("Event B");
    }
