...
public class GetPageAsync
{
    ...
    public async Task ReturnsPagedGuests_ExcludingDeleted()
    {
        ...
        {
            new GuestEntity { Id = Guid.NewGuid(), EventId = eventId, Information = new GuestInfoEntity { FirstName = "A" } },
            new GuestEntity { Id = Guid.NewGuid(), EventId = eventId, Information = new GuestInfoEntity { FirstName = "B" } },
            new GuestEntity { Id = Guid.NewGuid(), EventId = eventId, Information = new GuestInfoEntity { FirstName = "C" }, IsDeleted = true }
        };
        ...
        result.Items.First().Name.Trim().ShouldBe("A");
    }
