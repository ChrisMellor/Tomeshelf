...
public class GetAsync
{
    ...
    public async Task ReturnsPagedResult()
    {
        ...
        var snapshot = new GuestSnapshot(1, new List<GuestListItem>
        {
            new(Guid.NewGuid(), "Test Guest", "Test Description", "http://example.com/profile", "http://example.com/image.jpg", DateTimeOffset.UtcNow, null, false)
        });
        ...
        result.Items[0].Name.ShouldBe("Test Guest");
    }
}
