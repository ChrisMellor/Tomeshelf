...
public class BuildCallbackUri
{
    ...
    {
        // Arrange
        var options = new FitbitOptions { CallbackBaseUri = null, CallbackPath = "/api/fitbit/auth/callback" };
    ...
    {
        // Arrange
        var options = new FitbitOptions { CallbackBaseUri = null, CallbackPath = "callback" };
