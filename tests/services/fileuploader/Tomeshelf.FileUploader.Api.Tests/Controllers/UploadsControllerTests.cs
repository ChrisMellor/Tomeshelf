...
public class UploadsControllerTests
{
    ...
    public async Task Upload_ReturnsBadRequest_WhenArchiveIsEmpty()
    {
        ...
        badRequest.Value
                  .Should()
                  .Be("A bundle archive (.zip) file is required.");
    }
    ...
    public async Task Upload_ReturnsBadRequest_WhenCredentialsMissingAndDefaultsUnset()
    {
        ...
        badRequest.Value
                  .Should()
                  .Be("Google Drive OAuth credentials are missing. Authorise via the web app and try again.");
    }
    ...
    public async Task Upload_UsesCredentialOverrides_WhenProvided()
    {
        ...
        captured.Should()
                .NotBeNull();
        captured!.OverrideOptions
                 .Should()
                 .NotBeNull();
        captured.OverrideOptions!.ClientId
                .Should()
                .Be("override-client");
        captured.OverrideOptions
                .ClientSecret
    ...
    public async Task Upload_UsesDefaultOptions_WhenCredentialsMissing()
    {
        ...
        ok.Value
          .Should()
          .BeOfType<UploadsController.BundleUploadResponse>();
        captured.Should()
                .NotBeNull();
