...
public class HumbleBundleScraperTests
{
    ...
    public async Task ScrapeAsync_ParsesBundlesFromHtmlPayload()
    {
        ...
        factory.LastName
               .Should()
               .Be(HumbleBundleScraper.HttpClientName);
        handler.RequestMessage
               .Should()
               .NotBeNull();
        handler.RequestMessage!.RequestUri
               .Should()
               .Be(new Uri("https://www.humblebundle.com/bundles"));
        handler.RequestMessage
               .Method
               .Should()
               .Be(HttpMethod.Get);
        ...
        first.Url
             .Should()
             .Be("https://www.humblebundle.com/bundle-one");
        first.TileImageUrl
             .Should()
             .Be("https://img.test/tile.png");
        first.TileLogoUrl
             .Should()
             .Be("https://img.test/logo.png");
        first.HeroImageUrl
             .Should()
             .Be("https://img.test/hero.png");
        first.ShortDescription
             .Should()
             .Be("Deal {with} braces");
        first.StartsAt
             .Should()
             .Be(DateTimeOffset.Parse("2025-01-01T00:00:00Z"));
        first.EndsAt
             .Should()
             .Be(DateTimeOffset.Parse("2025-01-10T00:00:00Z"));
        first.ObservedUtc
             .Should()
             .BeOnOrAfter(before)
             .And
        ...
        second.Url
              .Should()
              .Be("https://www.humblebundle.com/bundle-two");
        second.TileImageUrl
              .Should()
              .Be("https://img.test/tile2.png");
        second.HeroImageUrl
              .Should()
              .Be("https://img.test/tile2.png");
        second.Stamp
