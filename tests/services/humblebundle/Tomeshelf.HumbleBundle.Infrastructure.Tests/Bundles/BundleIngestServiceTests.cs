...
public class BundleIngestServiceTests
{
    ...
    public async Task UpsertAsync_CreatesNewBundles_AndPopulatesTimestamps()
    {
        ...
        createdFirst.MachineName
                    .Should()
                    .Be("bundle-one");
        createdFirst.FirstSeenUtc
                    .Should()
                    .Be(observedFirst);
        createdFirst.LastSeenUtc
                    .Should()
                    .Be(observedFirst);
        createdFirst.LastUpdatedUtc
                    .Should()
                    .Be(observedFirst);
        createdFirst.Title
                    .Should()
        ...
        createdSecond.MachineName
                     .Should()
                     .Be("bundle-two");
        createdSecond.FirstSeenUtc
                     .Should()
                     .Be(observedSecond);
        createdSecond.LastSeenUtc
                     .Should()
                     .Be(observedSecond);
        createdSecond.LastUpdatedUtc
                     .Should()
                     .Be(observedSecond);
        createdSecond.Url
                     .Should()
                     .Be("https://example.com/bundle-two");
    }
    ...
    public async Task UpsertAsync_ReturnsZeros_WhenNoBundlesSupplied()
    {
        ...
        result.ObservedAtUtc
              ...
              .And
              .BeOnOrBefore(after);
        (await context.Bundles.CountAsync()).Should()
                                            .Be(1);
    }
    ...
    public async Task UpsertAsync_UpdatesExistingBundle_WhenFieldsChange()
    {
        ...
        var updated = await context.Bundles.SingleAsync();
        updated.FirstSeenUtc
               .Should()
               .Be(existingFirstSeen);
        updated.LastSeenUtc
               .Should()
               .Be(observed);
        updated.LastUpdatedUtc
