...
public sealed record PaissaPlotModel(int Ward, int Plot, long Price, int Entries, DateTimeOffset LastUpdatedUtc, string PurchaseCategory, string PurchaseCategoryKey);
