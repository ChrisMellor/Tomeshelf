...
public sealed record PersonModel
{
    ...
    [JsonPropertyName("publicly_visible")] public bool PubliclyVisible { get; init; }

    [JsonPropertyName("first_name")] public string FirstName { get; init; } = "";

    [JsonPropertyName("last_name")] public string LastName { get; init; } = "";

    [JsonPropertyName("alt_name")] public string AltName { get; init; }

    [JsonPropertyName("bio")] public string Bio { get; init; }

    [JsonPropertyName("known_for")] public string KnownFor { get; init; }
    ...
    [JsonPropertyName("video_link")] public string VideoLink { get; init; }

    [JsonPropertyName("twitter")] public string Twitter { get; init; }

    [JsonPropertyName("facebook")] public string Facebook { get; init; }

    [JsonPropertyName("instagram")] public string Instagram { get; init; }

    [JsonPropertyName("youtube")] public string YouTube { get; init; }

    [JsonPropertyName("twitch")] public string Twitch { get; init; }

    [JsonPropertyName("snapchat")] public string Snapchat { get; init; }

    [JsonPropertyName("deviantart")] public string DeviantArt { get; init; }

    [JsonPropertyName("tumblr")] public string Tumblr { get; init; }

    [JsonPropertyName("category")] public string Category { get; init; }

    [JsonPropertyName("days_at_show")] public string DaysAtShow { get; init; }

    [JsonPropertyName("booth_number")] public string BoothNumber { get; init; }
    ...
    [JsonPropertyName("images")] public List<ImageSetModel> Images { get; init; } = [];

    [JsonPropertyName("schedules")] public List<ScheduleModel> Schedules { get; init; } = [];

    [JsonPropertyName("removed_at")] public string RemovedAt { get; init; }
}