...
public sealed class PaissaService : IPaissaService
{
    private static readonly JsonSerializerOptions SerializerOptions = new(JsonSerializerDefaults.Web);
    private readonly HttpClient _http;
    private readonly ILogger<PaissaService> _logger;

    public PaissaService(HttpClient http, ILogger<PaissaService> logger)
    {
        _http = http;
        _logger = logger;
    }
