...
public sealed record PaissaPlotResponse
{
    ...
    public void Deconstruct(out int ward, out int plot, out long price, out int entries, out DateTimeOffset lastUpdatedUtc, out bool allowsPersonal, out bool allowsFreeCompany, out bool isEligibilityUnknown)
    {
        ward = Ward;
        plot = Plot;
        price = Price;
