...
using Tomeshelf.Infrastructure.Domains.Guests.Records;
using Tomeshelf.Infrastructure.Persistence;

namespace Tomeshelf.Infrastructure.Domains.Guests.Queries;
    ...
    private static IQueryable<PersonProjection> ProjectPeople(IQueryable<EventAppearance> source)
    {
        return source.Select(a => new PersonProjection
        {
            ...
            Person = new PersonDto
            {
                ...
                RemovedAt = a.Person.RemovedUtc != default
                                ? a.Person.RemovedUtc.ToString("o")
                                : null,
                Category = null,
