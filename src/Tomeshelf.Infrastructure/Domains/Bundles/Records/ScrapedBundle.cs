...
public sealed record ScrapedBundle
{
    ...
    public ScrapedBundle(string machineName, string category, string stamp, string title, string shortName, string url, string tileImageUrl, string tileLogoUrl, string heroImageUrl, string shortDescription, DateTimeOffset startsAt, DateTimeOffset endsAt, DateTimeOffset observedUtc)
    {
